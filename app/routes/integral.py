...
from app.classes.data import Integral
from app.classes.forms import IntegralForm
from flask_login import login_required
import datetime as dt


@app.route('/integralinfo')
def integralinfo():
    return render_template('integralinfo.html')
...
@app.route('/integral/new', methods=['GET', 'POST'])
...
def integralNew():
    ...
    # see how that works.
    return render_template('integralform.html',form=form)