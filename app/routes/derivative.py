...
from app.classes.data import Derivative
from app.classes.forms import DerivativeForm
from flask_login import login_required
import datetime as dt

@app.route('/derivativeinfo')
def derivativeinfo():
    return render_template('derivativeinfo.html')
...
@app.route('/derivative/new', methods=['GET', 'POST'])
...
def derivativeNew():
    ...
    # see how that works.
    return render_template('derivativeform.html',form=form)